  ...
  <div class="main">
    <a-form :form="form" class="user-layout-login" ref="formLogin" id="formLogin">
      ...
      <a-form-item>
        ...
        <router-link :to="{ name: 'alteration'}" class="forge-password" style="float: right;color:#fff">
          忘记密码
        </router-link>
       <router-link :to="{ name: 'register'}" class="forge-password" style="float: right;margin-right: 10px;color:#fff" >
          注册账户
        </router-link>
      </a-form-item>
