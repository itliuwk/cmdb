...
export default {
  ...
  methods: {
    ...
    getQueryParams() {
      ...
      //--update-begin----author:scott---date:20190818------for:新增公告时指定特定用户翻页错误SelectUserListModal #379----
      // param.current = this.ipagination.current;
      // param.pageSize = this.ipagination.pageSize;
      param.pageNo = this.ipagination.current
      param.pageSize = this.ipagination.pageSize
      //--update-end----author:scott---date:20190818------for:新增公告时指定特定用户翻页错误SelectUserListModal #379---
