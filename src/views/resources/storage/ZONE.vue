  ...
  <a-card :bordered="false">
    <div class="table-page-search-wrapper">
      <a-form layout="inline" :form="queryParam">
        <a-row :gutter="48">
          <a-col :md="5" :sm="24">
            <a-form-item label="端口名">
              <a-input v-model="queryParam.name" placeholder="请输入端口名" />
            </a-form-item>
          </a-col>

          <a-col :md="5" :sm="24">
            <a-form-item label="zone名称">
              <a-input v-model="queryParam.name" placeholder="请输入zone名称" />
            </a-form-item>
          </a-col>
    ...
    <a-modal :title="title" width="800px" :visible="visible" @ok="handleOk" @cancel="handleCancel">
      <d-zone v-if="visible" ref="dRouter"></d-zone>
    </a-modal>
  </a-card>
</template>
...
const columns = [
  ...
  { title: '光纤交换机名称', width: 100, dataIndex: 'opticalFiber', key: 'name' },
  { title: 'zone名称', dataIndex: 'zone', key: '1' },
  { title: '端口名称', dataIndex: 'port', key: '2' },
  { title: '配置文件名称', dataIndex: 'way', key: '3' },
...
import dZone from './dialog/d-ZONE'
