  ...
  <a-card :bordered="false">
    <div class="table-page-search-wrapper">
      <a-form layout="inline" :form="queryParam">
        <a-row :gutter="48">
          <a-col :md="5" :sm="24">
            <a-form-item label="LUN ID">
              <a-input v-model="queryParam.name" placeholder="请输入LUN ID" />
            </a-form-item>
          </a-col>

          <a-col :md="5" :sm="24">
            <a-form-item label="映射端口WWN">
              <a-input v-model="queryParam.name" placeholder="请输入映射端口WWN" />
            </a-form-item>
          </a-col>
          <template v-if="toggleSearchStatus">
            <a-col :md="5" :sm="24">
              <a-form-item label="映射主机名称">
                <a-input v-model="queryParam.name" placeholder="请输入映射主机名称" />
              </a-form-item>
            </a-col>
          </template>
          <a-col :md="8" :sm="24">
    ...
    <a-modal :title="title" width="800px" :visible="visible" @ok="handleOk" @cancel="handleCancel">
      <d-logical-config v-if="visible" ref="dRouter"></d-logical-config>
    </a-modal>
  </a-card>
</template>
...
const columns = [
  ...
  { title: '存储名称', width: 100, dataIndex: 'logic', key: 'name' },
  { title: '存储序列号', dataIndex: 'numbers', key: '1' },
  { title: 'LUN卷名', dataIndex: 'lun', key: '2' },
  { title: 'LUN ID', dataIndex: 'numbers', key: '3' },
  { title: '容量（GB）', dataIndex: 'gb', key: '4' },
  { title: 'RAID级别', dataIndex: 'cpuNumbers', key: '5' },
  { title: '是否映射', dataIndex: 'hav', key: '6' },
  { title: '映射主机名称', dataIndex: 'host', key: '7' },
  { title: '映射端口数量', dataIndex: 'cpu', key: '8' },
  { title: '映射端口WWN', dataIndex: 'port', key: '9' },
  {
    title: '操作',
    key: 'operation',
    width: 220,
...
import dLogicalConfig from './dialog/d-logicalConfig'
