<template>
  <a-card :bordered="false">
    ...
    <a-modal :title="title" width="800px" :visible="visible" @ok="handleOk" @cancel="handleCancel">
      <d-physicalTapeLibrary ref="dPhysicalTapeLibrary"></d-physicalTapeLibrary>
    </a-modal>
  </a-card>
</template>
...
const columns = [
  ...
  { title: '设备名称', dataIndex: 'physicalLibrary', key: 'name' },
  { title: '序列号', dataIndex: 'numbers', key: '1' },
  { title: '型号', dataIndex: 'numbering', key: '3' },
  { title: '制造商', dataIndex: 'physical', key: '4' },
  { title: '微码版本', dataIndex: 'version', key: '5' },
  { title: '管理IP', dataIndex: 'ip', key: '6' },
  { title: '驱动器数量', dataIndex: 'cpu', key: '7' },
  { title: '磁带数量', dataIndex: 'cpuNumbers', key: '8' },
  { title: '单个磁带容量（TB）', dataIndex: 'cpu', key: '9' },
  { title: '清洗带数量', dataIndex: 'guid', key: '10' },
  { title: '驱动器端口数量', dataIndex: 'cpu', key: '11' },
  { title: '额定功率（KW）', dataIndex: 'rated', key: '12' },
  { title: '维保开始日期', dataIndex: 'date', key: '15' },
  { title: '维保结束日期', dataIndex: 'dateEnd', key: '16' },
  { title: '维保服务商', dataIndex: 'create', key: '17' },
  { title: '地理位置', dataIndex: 'address', key: '18' },
  { title: '机房', dataIndex: 'room', key: '19' },
  { title: '机柜', dataIndex: 'cabinet', key: '20' },
  { title: '驱动器WWPN列表', dataIndex: 'equipmentType', key: '21' },
  {
    title: '操作',
    key: 'operation',
    width: 200,
...
import dPhysicalTapeLibrary from './dialog/d-physicalTapeLibrary'
...
export default {
  ...
  methods: {
    ...
    handleCancel() {
      this.visible = false
      let dPhysicalTapeLibrary = this.$refs['dPhysicalTapeLibrary']
      dPhysicalTapeLibrary.resetForm()
    },
    del(index) {
      const that = this
      this.$confirm({
    ...
    handleOk() {
      ...
      let dPhysicalTapeLibrary = this.$refs['dPhysicalTapeLibrary']
      dPhysicalTapeLibrary.onSubmit().then((res) => {
        if (res.is) {
