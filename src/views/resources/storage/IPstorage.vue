<template>
  <a-card :bordered="false">
    ...
    <a-modal :title="title" width="800px" :visible="visible" @ok="handleOk" @cancel="handleCancel">
      <d-IPstorage ref="dIPstorage"></d-IPstorage>
    </a-modal>
  </a-card>
</template>
...
const columns = [
  ...
  { title: '设备名称', width: 100, dataIndex: 'physical', key: 'name' },
  { title: '序列号', dataIndex: 'numbers', key: '1' },
  { title: '扩展序列号', dataIndex: 'regexp', key: '2' },
  { title: '型号', dataIndex: 'ipTypes', key: '3' },
  { title: '制造商', dataIndex: 'physical', key: '4' },
  { title: '微码版本', dataIndex: 'version', key: '5' },
  { title: '管理IP', dataIndex: 'ip', key: '6' },
  { title: '磁盘数量', dataIndex: 'cpu', key: '7' },
  { title: '存储裸容量（GB）', dataIndex: 'gb', key: '9' },
  { title: '存储可用容量（GB）', dataIndex: 'ram', key: '10' },
  { title: '存储剩余容量（GB）', dataIndex: 'gb', key: '11' },
  { title: 'U高', dataIndex: 'uHeight', key: '12' },
  { title: '额定功率（KW）', dataIndex: 'power', key: '13' },
  { title: '电流（A）', dataIndex: 'power', key: '14' },
  { title: '维保开始日期', dataIndex: 'date', key: '15' },
  { title: '维保结束日期', dataIndex: 'dateEnd', key: '16' },
  { title: '维保服务商', dataIndex: 'physical', key: '17' },
  { title: '地理位置', dataIndex: 'address', key: '18' },
  { title: '机房', dataIndex: 'room', key: '21' },
  { title: '机柜', dataIndex: 'cabinet', key: '19' },
  { title: 'U位', dataIndex: 'cpu', key: '20' },
  {
    title: '操作',
    key: 'operation',
    width: 200,
...
import dIPstorage from './dialog/d-IPstorage'
...
export default {
  ...
  methods: {
    ...
    handleCancel() {
      this.visible = false
      let dIPstorage = this.$refs['dIPstorage']
      dIPstorage.resetForm()
    },
    del(index) {
      const that = this
      this.$confirm({
