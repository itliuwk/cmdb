<template>
  <a-card :bordered="false">
    ...
    <a-modal :title="title" width="800px" :visible="visible" @ok="handleOk" @cancel="handleCancel">
      <d-Instance ref="dInstance"></d-Instance>
    </a-modal>
  </a-card>
</template>
...
const columns = [
  { title: '序号', width: 100, dataIndex: 'number', key: 'number', align: 'center' },
  { title: '集群名称', width: 100, dataIndex: 'type', key: 'name', align: 'center' },
  { title: '实例类型', dataIndex: 'mode', key: '1', align: 'center' },
  { title: '中间件版本', dataIndex: 'version', key: '2', align: 'center' },
  { title: '中间件补丁', dataIndex: 'patch', key: '3', align: 'center' },
  { title: '服务IP', dataIndex: 'ip', key: '4', align: 'center' },
  { title: '服务端口', dataIndex: 'port', key: '5', align: 'center' },
  { title: '所属集群', dataIndex: 'type', key: '6', align: 'center' },
  { title: '所属虚拟机', dataIndex: 'virtual', key: '7', align: 'center' },
  { title: '所属物理机', dataIndex: 'physical', key: '8', align: 'center' },
  {
    title: '操作',
    key: 'operation',
    width: 200,
...
import dInstance from './dialog/d-instance.vue'
...
export default {
  ...
  methods: {
    ...
    handleOk() {
      ...
      let dInstance = this.$refs['dInstance']
      dInstance.onSubmit().then((res) => {
        if (res.is) {
