<template>
  <a-card :bordered="false">
    ...
    >
      <d-console ref="dConsole"></d-console>
    </a-modal>
  </a-card>
</template>
...
import dConsole from './dialog/d-virtual'
...
export default {
  ...
  methods: {
    ...
    handleCancel() {
      this.visible = false
      let dConsole = this.$refs['dConsole']
      dConsole.resetForm()
    },
    del(index) {
      const that = this
