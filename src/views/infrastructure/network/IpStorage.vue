<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="机柜">
              <a-input placeholder="请输入机柜" v-model="queryParam.cabinetId"></a-input>
            </a-form-item>
          </a-col>
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('ip存储')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <ipStorage-modal ref="modalForm" @ok="modalFormOk"></ipStorage-modal>
  </a-card>
</template>

<script>
  import '@/assets/less/TableExpand.less'
  import IpStorageModal from './modules/IpStorageModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        columns: [
          {
           ...
           },
		   {
            title: '存储可用容量',
            align:"center",
            dataIndex: 'storageAvailableCapacity'
           },
		   {
            title: '存储剩余容量',
            align:"center",
            dataIndex: 'storageRemainingCapacity'
           },
		   {
            title: 'U高',
            align:"center",
		...
		url: {
          list: "/cmdb/ipStorage/list",
          delete: "/cmdb/ipStorage/delete",
          deleteBatch: "/cmdb/ipStorage/deleteBatch",
          exportXlsUrl: "cmdb/ipStorage/exportXls",
          importExcelUrl: "cmdb/ipStorage/importExcel",
       },
    }
  },
  computed: {
