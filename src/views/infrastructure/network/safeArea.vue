<template>
  ...
  <a-card :bordered="false">
        ...
        <a-row :gutter="48">
          <a-col :md="5" :sm="24">
            <a-form-item label="简称">
              <a-input v-model="queryParam.name" placeholder="请输入简称" />
            </a-form-item>
          </a-col>

          <a-col :md="5" :sm="24">
            <a-form-item label="安全区域名">
              <a-input v-model="queryParam.name" placeholder="请输入安全区域名" />
            </a-form-item>
          </a-col>
    ...
    <a-modal :title="title" width="800px" :visible="visible" @ok="handleOk" @cancel="handleCancel">
      <d-safe-area v-if="visible" ref="dRouter"></d-safe-area>
    </a-modal>
  </a-card>
</template>
...
const columns = [
  ...
  { title: '简称', width: 100, dataIndex: 'areaName', key: 'age' },
  { title: '安全区域名', dataIndex: 'area', key: '1' },
  { title: '接入设备', dataIndex: 'physical', key: '2' },
  { title: 'VLAN', dataIndex: 'vlan', key: '3' },
...
import dSafeArea from './dialog/d-safeArea'
