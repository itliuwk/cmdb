<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="防火墙名称">
              <a-input placeholder="请输入防火墙名称" v-model="queryParam.firewallName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('防火墙')">导出</a-button>
      <a-upload
        name="file"
    ...
    <!-- 表单区域 -->
    <firewall-modal ref="modalForm" @ok="modalFormOk"></firewall-modal>
  </a-card>
</template>

<script>
import '@/assets/less/TableExpand.less'
import FirewallModal from './modules/FirewallModal'
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/cmdb/firewall/list',
        delete: '/cmdb/firewall/delete',
        deleteBatch: '/cmdb/firewall/deleteBatch',
        exportXlsUrl: 'cmdb/firewall/exportXls',
        importExcelUrl: 'cmdb/firewall/importExcel',
      },
    }
  },
  computed: {
