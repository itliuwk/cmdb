<template>
  <a-card :bordered="false">
      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="管理ip">
                <a-input placeholder="请输入管理ip" v-model="queryParam.ipId"></a-input>
              </a-form-item>
            </a-col>
          </template>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('负载均衡')">导出</a-button>
      <a-upload
        name="file"
    ...
    <!-- 表单区域 -->
    <loadBalancing-modal ref="modalForm" @ok="modalFormOk"></loadBalancing-modal>
  </a-card>
</template>

<script>
import '@/assets/less/TableExpand.less'
import loadBalancingModal from './modules/loadBalancingModal'
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/cmdb/loadBalancing/list',
        delete: '/cmdb/loadBalancing/delete',
        deleteBatch: '/cmdb/loadBalancing/deleteBatch',
        exportXlsUrl: 'cmdb/loadBalancing/exportXls',
        importExcelUrl: 'cmdb/loadBalancing/importExcel',
      },
    }
  },
  computed: {
