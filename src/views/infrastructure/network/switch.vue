<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('网络交换机')">导出</a-button>
      <a-upload
        name="file"
    ...
    <!-- 表单区域 -->
    <networkSwitch-modal ref="modalForm" @ok="modalFormOk"></networkSwitch-modal>
  </a-card>
</template>

<script>
import '@/assets/less/TableExpand.less'
import NetworkSwitchModal from './modules/NetworkSwitchModal'
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/cmdb/networkSwitch/list',
        delete: '/cmdb/networkSwitch/delete',
        deleteBatch: '/cmdb/networkSwitch/deleteBatch',
        exportXlsUrl: 'cmdb/networkSwitch/exportXls',
        importExcelUrl: 'cmdb/networkSwitch/importExcel',
      },
    }
  },
  computed: {
