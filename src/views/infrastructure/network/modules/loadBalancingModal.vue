  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/cmdb/loadBalancing/add",
          edit: "/cmdb/loadBalancing/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'serialNumber','model','manufacturer','osVersion','ipId','uHigh','ratedPower','maintenanceStartDate','maintenanceEndTime','maintenaceServiceProvider','location','uBit','cabinetId'))
		  //时间格式化
        });
      ...
      handleOk () {
        ...
        this.form.validateFields((err, values) => {
          if (!err) {
            ...
            //时间格式化
            formData.maintenanceStartDate = formData.maintenanceStartDate?formData.maintenanceStartDate.format('YYYY-MM-DD HH:mm:ss'):null;
