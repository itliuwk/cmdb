  ...
  >
    <div class="form-control">
      <a-spin :spinning="confirmLoading">
        <a-form :form="form">
          <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="路由器名称">
            <a-input placeholder="请输入路由器名称" v-decorator="['routerName', validatorRules.routerName]" />
          </a-form-item>
          ...
          <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="OS版本">
          ...
          <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="U高">
            <a-input placeholder="请输入U高" v-decorator="['unitHigh', validatorRules.unitHigh]" />
          </a-form-item>
          ...
          <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="U位">
            <a-input placeholder="请输入U位" v-decorator="['unitBit', {}]" />
          </a-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      validatorRules: {
        routerName: { rules: [{ required: true, message: '请输入路由器名称!' }] },
