  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/cmdb/networkSwitch/add",
          edit: "/cmdb/networkSwitch/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'switchName','serialNumber','model','manufacturer','osVersion','ipId','uHigh','ratedPower','maintenanceStartDate','maintenanceEndTime','maintenaceServiceProvider','location','uBit','cabinetId'))
		  //时间格式化
        });
      ...
      handleOk () {
        ...
        this.form.validateFields((err, values) => {
          if (!err) {
            ...
            //时间格式化
            formData.maintenanceStartDate = formData.maintenanceStartDate?moment(formData.maintenanceStartDate).format('YYYY-MM-DD HH:mm:ss'):null;
            formData.maintenanceEndTime = formData.maintenanceEndTime?moment(formData.maintenanceEndTime).format('YYYY-MM-DD HH:mm:ss'):null;
