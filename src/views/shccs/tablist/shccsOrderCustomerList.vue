<template>
  <a-card :bordered="false">
    ...
    <!-- table区域-end -->
    <!-- 表单区域 -->
    <shccsOrderCustomer-modal ref="modalForm" @ok="modalFormOk"></shccsOrderCustomer-modal>
  </a-card>
</template>

<script>
  import shccsOrderCustomerModal from './form/shccsOrderCustomerModal'
  import shccsOrderDMainList from './shccsOrderDMainList'
  import {shccsListMixin} from '@/mixins/shccsListMixin'
  import {getAction} from '@/api/manage'

  export default {
    name: "shccsOrderCustomerList",
