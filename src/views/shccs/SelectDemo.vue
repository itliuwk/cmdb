...
<script>
  ...
  import JSelectDepart from '@/components/shccsbiz/JSelectDepart'
  import JSelectUserByDep from '@/components/shccsbiz/JSelectUserByDep'
  import JSelectMultiUser from '@/components/shccsbiz/JSelectMultiUser'
  import JSelectRole from '@/components/shccsbiz/JSelectRole'
  import JCheckbox from '@/components/shccs/JCheckbox'
  import JCodeEditor from '@/components/shccs/JCodeEditor'
  import JDate from '@/components/shccs/JDate'
  import JEditor from '@/components/shccs/JEditor'
  import JEllipsis from '@/components/shccs/JEllipsis'
  import JSlider from '@/components/shccs/JSlider'
  import JSelectMultiple from '@/components/shccs/JSelectMultiple'
  import JTreeDict from "../../components/shccs/JTreeDict.vue";
  import JCron from "@/components/shccs/JCron.vue";
  import JTreeSelect from '@/components/shccs/JTreeSelect'
  import JSuperQuery from '@/components/shccs/JSuperQuery'
  import JUpload from '@/components/shccs/JUpload'
  import JImageUpload from '@/components/shccs/JImageUpload'
  import JSelectPosition from '@comp/shccsbiz/JSelectPosition'
  import JCategorySelect from '@comp/shccs/JCategorySelect'
  import JMultiSelectTag from '@comp/dict/JMultiSelectTag'
  import JInput from '@comp/shccs/JInput'
  import JAreaLinkage from '@comp/shccs/JAreaLinkage'
  import JMarkdownEditor from '@/components/shccs/JMarkdownEditor/index'
  ...
  export default {
    ...
    data() {
      return {
        ...
        userIds: 'admin',
        multiUser: 'admin,shccs',
        jcheckbox: {
          values: 'spring,shccsboot',
          options: [
            { label: 'shccs', value: 'shccs' },
            { label: 'shccs-Boot', value: 'shccsboot' },
