...
<script>
  ...
  import JEditableTable from '@/components/shccs/JEditableTable'
  ...
  export default {
    name: 'shccsOrderModalForJEditableTable',
    components: {
    ...
    methods: {
      ...
      classifyIntoFormData(allValues) {
        ...
        return {
          ...orderMain, // 展开
          shccsOrderCustomerList: allValues.tablesValue[0].values,
          shccsOrderTicketList: allValues.tablesValue[1].values
        }
      },
      /** 发起新增或修改的请求 */
