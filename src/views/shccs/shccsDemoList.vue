<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <shccsDemo-modal ref="modalForm" @ok="modalFormOk"></shccsDemo-modal>

    <!-- 一对多表单区域 -->
    <shccsDemoTabsModal ref="shccsDemoTabsModal" @ok="modalFormOk"></shccsDemoTabsModal>

  </a-card>
</template>

<script>
  import shccsDemoModal from './modules/shccsDemoModal'
  import JSuperQuery from '@/components/shccs/JSuperQuery.vue';
  import JInput from '@/components/shccs/JInput.vue';
  import shccsDemoTabsModal from './modules/shccsDemoTabsModal'
  ...
  export default {
    ...
    data() {
      return {
        ...
        //字典数组缓存
        sexDictOptions: [],
        importExcelUrl:`${window._CONFIG['domianURL']}/test/shccsDemo/importExcel`,
        //表头
        columns:[],
        //列设置
        settingColumns:[],
        ...
        url: {
          list: "/test/shccsDemo/list",
          delete: "/test/shccsDemo/delete",
          deleteBatch: "/test/shccsDemo/deleteBatch",
          exportXlsUrl: "/test/shccsDemo/exportXls"
        },
    ...
    methods: {
      ...
      onetomany: function () {
        this.$refs.shccsDemoTabsModal.add();
        this.$refs.shccsDemoTabsModal.title = "编辑";
      },
      //跳转单据页面
      jump() {
        this.$router.push({path: '/shccs/helloworld'})
      },
