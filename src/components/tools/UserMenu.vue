<template>
  <div class="user-wrapper" :class="theme">
    ...
    <span class="action" @click="showClick">
      <a-icon type="search" style="fontSize:22px; vertical-align: middle;"></a-icon>
    </span>
    ...
    <!-- <span class="action">
      <a class="logout_title" target="_blank" href="http://doc.shccs.com">
...
export default {
  ...
  created() {
    ...
    this.searchMenus(lists, routers)
  ...
  methods: {
    ...
    searchMenus(arr, menus) {
      for (let i of menus) {
        if (!i.hidden && 'layouts/RouteView' !== i.component && !i.children) {
          arr.push(i)
        }
