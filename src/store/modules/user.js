...
const user = {
  ...
  mutations: {
    ...
    SET_CURRROUTERID: (state, id) => {
      state.currRouterId = id
    },
  },
      ...
      return new Promise((resolve, reject) => {
        ...
        queryPermissionsByUser(params).then(response => {
          ...
          if (menuData && menuData.length > 0) {
            //update--begin--autor:qinfeng-----date:20200109------for：shccs-63 一级菜单的子菜单全部是隐藏路由，则一级菜单不显示------
            ...
            //update--end--autor:qinfeng-----date:20200109------for：shccs-63 一级菜单的子菜单全部是隐藏路由，则一级菜单不显示------
